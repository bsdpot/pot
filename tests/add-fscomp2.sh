...
test_pot_add_fscomp_101()
{
	...
	assertEquals "echo calls" "2" "$ECHO_CALLS"
	...
	assertEquals "echo arg" "$POT_ZFS_ROOT/fscomp/test-fscomp $POT_FS_ROOT/jails/test-pot/m/test-mnt" "$ECHO_CALL2_ARG1"
	...
	assertEquals "echo arg" "zroot/test-fscomp $POT_FS_ROOT/jails/test-pot/m/test-mnt" "$ECHO_CALL2_ARG1"
}
...
test_pot_add_fscomp_102()
{
	...
	assertEquals "echo arg" "$POT_ZFS_ROOT/fscomp/test-fscomp $POT_FS_ROOT/jails/test-pot/m/test-mnt ro" "$ECHO_CALL2_ARG1"
	...
	assertEquals "echo arg" "$POT_ZFS_ROOT/fscomp/test-fscomp $POT_FS_ROOT/jails/test-pot/m/test-mnt zfs-remount" "$ECHO_CALL2_ARG1"
	...
	assertEquals "echo arg" "zroot/test-fscomp $POT_FS_ROOT/jails/test-pot/m/test-mnt ro" "$ECHO_CALL2_ARG1"
	...
	assertEquals "echo arg" "zroot/test-fscomp $POT_FS_ROOT/jails/test-pot/m/test-mnt zfs-remount" "$ECHO_CALL2_ARG1"
}
