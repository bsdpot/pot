...
test_js_export_ports_001()
{
	...
	assertEquals "pfrules lines" "1" "$( wc -l /tmp/pot_test-pot80_pfrules | cut -w -f 2)"
...
test_js_export_ports_002()
{
	...
	assertEquals "pfctl calls" "1" "$PFCTL_CALLS"
	assertEquals "pfrules lines" "1" "$( wc -l /tmp/pot_test-pot80s3000_pfrules | cut -w -f 2)"
...
test_js_export_ports_003()
{
	...
	assertEquals "pfctl calls" "1" "$PFCTL_CALLS"
	assertEquals "pfrules lines" "2" "$( wc -l /tmp/pot_test-pot80433_pfrules | cut -w -f 2)"
